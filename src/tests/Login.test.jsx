...
describe('Componente Login (Usuario Desconectado)', () => {
  ...
  // Test TC-023: Verificar renderizado del formulario y lógica de useEffect sin sesión
  ...
  // Test TC-024: Verificar llamada a validarTodo() al enviar el formulario
...
describe('Componente Login (Usuario Ya Conectado)', () => {
  ...
  // Test TC-025: Verificar redirección si ya hay sesión activa
